# script taken from http://www.mypoint.se/wp-content/uploads/2008/06/html_diff.rb
# which is based on http://dev.rubyonrails.org/browser/tools/i2/vendor/html_diff/lib/html_diff.rb?rev=2294
...
module HTMLDiff
  ...
  class Builder
    ...
    def op_helper(tagname, tagclass, to_add)
      # NOTE: Uncommented this for QACE availability
